...
function renderCRUDTable(type, data) {
    let tbodyId = `crud-${type}-tbody`;
    if (type === 'work_session') tbodyId = 'crud-worksession-tbody';
...
function filterCRUDEmp() {
    let input = document.getElementById('search-crud-emp');
    let filter = input.value.toLowerCase();
    let tbody = document.getElementById('crud-employee-tbody');
